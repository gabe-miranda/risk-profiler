...
describe('UserAgeRiskProvider', () => {
  ...
  it('should set disability and life insurance lines to inelegible and should not change risk score when user age is over 60 years old', () => {
    ...
    expect(riskProfile.disability).toBe(RiskProfileStatus.INELEGIBLE);
    expect(riskProfile.life).toBe(RiskProfileStatus.INELEGIBLE);
  });
